...
const AlumniPage = () => {
  ...
  const navigationItems = [
    ...
    { id: 'register', label: 'Register', icon: Heart }
  ];
        ...
        {activeSection === 'register' && (
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Daftar sebagai Alumni</h2>
              <div className="max-w-2xl mx-auto">
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Tahun Graduasi</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Syarikat/Organisasi</label>
                    <input type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                  </div>
                  <button onClick={() => alert('Pendaftaran berjaya dihantar!')} className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium">
                    Hantar Pendaftaran
                  </button>
                </div>
              </div>
