...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Sections: Schema.Attribute.DynamicZone<
      [
        'school-history.pengenalan',
        'school-history.pencapaian',
        'school-history.misi-dan-matlamat',
        'school-history.kepimpinan-sekolah',
        'school-history.kemudahan-dan-pembinaan',
...
export interface ApiGalleriMomentGalleriMoment extends Struct.SingleTypeSchema {
  collectionName: 'galleri_moments';
  info: {
    displayName: 'GalleriMoment';
    pluralName: 'galleri-moments';
    singularName: 'galleri-moment';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::galleri-moment.galleri-moment'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Sections: Schema.Attribute.DynamicZone<['galleri-moment.moment']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Sections: Schema.Attribute.DynamicZone<
      [
        'homepage.testimoials',
        'homepage.latest-updates',
        'homepage.hero-section',
        'homepage.footer',
        'homepage.extra-activities-highlight',
        'homepage.excellence-in-numbers',
        'homepage.academic-excellence',
...
export interface ApiLatestAnnouncementLatestAnnouncement
  extends Struct.SingleTypeSchema {
  collectionName: 'latest_announcements';
  info: {
    displayName: 'LatestAnnouncement';
    pluralName: 'latest-announcements';
    singularName: 'latest-announcement';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    announcements: Schema.Attribute.Component<
      'latest-announcementpage.announement',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::latest-announcement.latest-announcement'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
